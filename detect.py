...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5x_d0.1_w0.03_layer_134_test4_kd5_qiou0.2.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default="./test/new", help='file/dir/URL/glob/screen/0(webcam)')
